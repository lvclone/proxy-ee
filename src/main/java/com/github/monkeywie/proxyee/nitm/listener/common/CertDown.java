package com.github.monkeywie.proxyee.nitm.listener.common;
 ...
 */
public class CertDown implements ProxyeeProxyListener {
    ...
    /**
     * Using proxyee's own CA certificate to construct CertDown
     */
    public CertDown() {
    }

    /**
     * Using CA public key in {@linkplain HttpProxyCACertFactory CaCertFactory} to construct CertDown
     ...
     */
    public CertDown(HttpProxyCACertFactory certFactory) throws Exception {
        this.cert = certFactory.getCACert();
    }

    /**
     * Provide certificate structure CertDown directly.
     *
     * @param caCert The public key of CA certificate consistent with
     *               {@link com.github.monkeywie.proxyee.server.HttpProxyServer}.
     */
    public CertDown(X509Certificate caCert) {
        this.cert = caCert;
    }
