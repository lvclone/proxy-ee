...
public abstract class FullRequestInterceptListener implements ProxyeeProxyListener {
    ...
    public FullRequestInterceptListener() {
        this(DEFAULT_MAX_CONTENT_LENGTH);
    }

    public FullRequestInterceptListener(int maxContentLength) {
