...
package com.github.monkeywie.proxyee.nitm.exception;

import java.util.function.Supplier;

import static java.lang.String.format;

public class ProxyeeProxyException extends RuntimeException {

    public ProxyeeProxyException(String message) {
        super(message);
    }

    public ProxyeeProxyException(String message, Throwable cause) {
        super(message, cause);
    }

    public static Supplier<ProxyeeProxyException> toThrow(String message, Object... args) {
        return () -> new ProxyeeProxyException(format(message, args));
    }
}
