...
public abstract class FullResponseInterceptListener implements ProxyeeProxyListener {
    ...
    public FullResponseInterceptListener() {
        this(DEFAULT_MAX_CONTENT_LENGTH);
    }

    public FullResponseInterceptListener(int maxContentLength) {
