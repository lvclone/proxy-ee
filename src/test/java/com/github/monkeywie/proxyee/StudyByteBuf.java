...
//        ByteUtil.insertText(httpResponseJsBuf, index, httpResponseJs);
    ...
    @Test
    public void test1(){
        String url = "https://fe-static.xhscdn.com/formula-static/xhs-pc-web/public/js/runtime.4a87331.js";
        ...
        for (String domainName : domainNames) {
            ...
            System.out.println("" + url.matches("^(.*?)" + domainName + "(.*?)$"));

//            return url.matches("^(.*?)" + domainName + "(.*?)$");
        }
